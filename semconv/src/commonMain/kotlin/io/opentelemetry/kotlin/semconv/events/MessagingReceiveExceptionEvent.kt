...
// Autogenerated OpenTelemetry semantic convention event for 'messaging.receive.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during a messaging receive operation.</p>
* <p>Notes:</p>
...
* Instrumentations MAY provide a configuration option to populate exception events with the attributes captured on the corresponding messaging receive span.</p>
*/
@ExperimentalApi
@IncubatingApi
class MessagingReceiveExceptionEvent(
    /**
    ...
    */
    ...
    override fun emit(
        ...
        logger.emit(
            eventName = "messaging.receive.exception",
        ) {

...
// Autogenerated OpenTelemetry semantic convention event for 'messaging.send.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during a messaging send operation.</p>
* <p>Notes:</p>
...
* Instrumentations MAY provide a configuration option to populate exception events with the attributes captured on the corresponding messaging send span.</p>
*/
@ExperimentalApi
@IncubatingApi
class MessagingSendExceptionEvent(
    /**
    ...
    */
    ...
    override fun emit(
        ...
        logger.emit(
            eventName = "messaging.send.exception",
        ) {

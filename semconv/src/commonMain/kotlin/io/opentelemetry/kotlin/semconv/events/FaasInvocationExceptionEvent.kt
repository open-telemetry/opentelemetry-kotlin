...
// Autogenerated OpenTelemetry semantic convention event for 'faas.invocation.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during FaaS function invocation, such as application errors, internal failures, or other exceptions that prevent the function from completing successfully.</p>
* <p>Notes:</p>
...
* Instrumentations MAY provide a configuration option to populate exception events with the attributes captured on the corresponding FaaS span.</p>
*/
@ExperimentalApi
@OptIn(IncubatingApi::class)
class FaasInvocationExceptionEvent(
    /**
    ...
    */
    ...
    override fun emit(logger: Logger) {
        logger.emit(
            eventName = "faas.invocation.exception",
        ) {

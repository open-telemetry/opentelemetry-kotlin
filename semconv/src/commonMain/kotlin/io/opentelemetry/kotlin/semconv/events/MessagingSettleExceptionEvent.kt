...
// Autogenerated OpenTelemetry semantic convention event for 'messaging.settle.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during a messaging settle operation.</p>
* <p>Notes:</p>
...
* Instrumentations MAY provide a configuration option to populate exception events with the attributes captured on the corresponding messaging settle span.</p>
*/
@ExperimentalApi
@OptIn(IncubatingApi::class)
class MessagingSettleExceptionEvent(
    /**
    ...
    */
    ...
    override fun emit(logger: Logger) {
        logger.emit(
            eventName = "messaging.settle.exception",
        ) {

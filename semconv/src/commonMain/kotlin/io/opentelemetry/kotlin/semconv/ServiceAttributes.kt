...
object ServiceAttributes {
    ...
    * The process executable name is the name of the process executable, the same value as described by the <a href="process.md"><c>process.executable.name</c></a> resource attribute.</p>
    */

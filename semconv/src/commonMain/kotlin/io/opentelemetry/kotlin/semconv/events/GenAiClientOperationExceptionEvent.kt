...
// Autogenerated OpenTelemetry semantic convention event for 'gen_ai.client.operation.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during a Generative AI client operation, such as API errors, rate limiting, model errors, timeouts, or other errors that prevent the operation from completing successfully.</p>
* <p>Notes:</p>
* <p>This event SHOULD be recorded when an exception occurs during Generative AI client operations.
* Instrumentations SHOULD set the severity to WARN (severity number 13) when recording this event.
* Instrumentations MAY provide a configuration option to populate exception events with the attributes captured on the corresponding Generative AI client span.</p>
*/
@ExperimentalApi
@IncubatingApi
class GenAiClientOperationExceptionEvent(
    /**

...
// Autogenerated OpenTelemetry semantic convention event for 'http.client.request.exception'.
//
// DO NOT EDIT - AUTOGENERATED FILE
/**
* <p>This event represents an exception that occurred during an HTTP client request, such as network failures, timeouts, or other errors that prevent the request from completing successfully.</p>
* <p>Notes:</p>

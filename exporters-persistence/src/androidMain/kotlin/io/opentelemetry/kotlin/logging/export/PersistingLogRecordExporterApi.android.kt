...
internal fun createPersistingLogRecordProcessor(
    ...
    clock: Clock,
    serializer: (List<io.opentelemetry.kotlin.logging.model.ReadableLogRecord>) -> ByteArray,
    deserializer: (ByteArray) -> List<io.opentelemetry.kotlin.logging.model.ReadableLogRecord>,
